...
IMAGE_DEPENDS = "imdt-image-isp"

SWUPDATE_IMAGES_${MACHINE}= " \
    bl2_bp_spi-${MACHINE}.bin \
    fip-${MACHINE}.bin \
    imdt-image-isp-${MACHINE} \
"
...
SWUPDATE_IMAGES_FSTYPES[imdt-image-isp-imdt-v2h-sbc] = ".tar.gz"
SWUPDATE_IMAGES_FSTYPES[imdt-image-isp-imdt-v2n-sbc] = ".tar.gz"
